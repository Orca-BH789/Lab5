...
const styles = StyleSheet.create({
  ...
  screenTitle: { fontSize: 32, fontWeight: '700', color: Colors.black, paddingTop: 10 },
  input: { marginVertical: 5, padding: 5, borderRadius: 8, borderColor: Colors.lightGray }, // improve input field appearance
  button: { width: '100%', justifyContent: 'center', alignItems: 'center', marginTop: 16, backgroundColor: Colors.orange, padding: 12, borderRadius: 8 },
